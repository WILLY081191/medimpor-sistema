...
const INIT_PRODUCTOS = [
  {
    id: 'CEL-001',
    nombre: 'Samsung Galaxy A35 128GB',
    marca: 'Samsung',
    categoria: 'Celular',
    stock: 8,
    stockMin: 3,
  ...
  {
    id: 'CEL-002',
    nombre: 'Samsung Galaxy A55 256GB',
    marca: 'Samsung',
    categoria: 'Celular',
    stock: 5,
    stockMin: 3,
  ...
  {
    id: 'ACC-001',
    nombre: 'Cable USB-C Original 1m',
    marca: 'Varios',
    categoria: 'Accesorio',
    stock: 1,
    stockMin: 5,
  ...
  {
    id: 'ACC-004',
    nombre: 'Funda Silicona Samsung A35',
    marca: 'Varios',
    categoria: 'Accesorio',
    stock: 25,
    stockMin: 10,
...
const INIT_VENTAS = [
  {
    id: 'VTA-0001',
    fecha: '2026-04-25',
    vendedor: 'Carlos (Admin)',
    cliente: 'Juan Pérez',
    productoId: 'CEL-001',
    producto: 'Samsung Galaxy A35 128GB',
    categoria: 'Celular',
    cantidad: 1,
    precioUnit: 1550,
    total: 1550,
  ...
  },
  {
    ...
    cliente: 'Ana Flores',
    productoId: 'ACC-002',
    producto: 'Audífonos Bluetooth TWS',
    categoria: 'Accesorio',
    cantidad: 2,
    precioUnit: 220,
    total: 440,
  ...
  },
  {
    ...
    productoId: 'PC-002',
    producto: 'SSD 500GB SATA Samsung',
    categoria: 'Componente PC',
    cantidad: 1,
    precioUnit: 400,
    total: 400,
  ...
  },
  {
    ...
    cliente: 'Rosa Quispe',
    productoId: 'CEL-004',
    producto: 'Xiaomi Redmi Note 13 128GB',
    categoria: 'Celular',
    cantidad: 1,
    precioUnit: 1150,
    total: 1150,
  ...
  },
  {
    ...
    cliente: 'Luis Vargas',
    productoId: 'ACC-003',
    producto: 'Cargador 65W GaN USB-C',
    categoria: 'Accesorio',
    cantidad: 1,
    precioUnit: 290,
    total: 290,
  ...
  },
  {
    ...
    fecha: '2026-04-23',
    vendedor: 'Carlos (Admin)',
    cliente: 'Carmen Ramos',
    productoId: 'CEL-002',
    producto: 'Samsung Galaxy A55 256GB',
    categoria: 'Celular',
    cantidad: 1,
    precioUnit: 2000,
    total: 2000,
...
const INIT_CAJA = [
  ...
  },
  {
    ...
    fecha: '2026-04-10',
    tipo: 'Egreso',
    concepto: 'Lote importación LT-001',
...
const INIT_LOTES = [
  {
    id: 'LT-001',
    fecha: '2026-04-10',
    proveedor: 'TechDistributor China',
    descripcion: 'Celulares Samsung y Xiaomi',
    origenUSD: 4800,
    tipoCambio: 6.97,
    flete: 1200,
    seguro: 180,
